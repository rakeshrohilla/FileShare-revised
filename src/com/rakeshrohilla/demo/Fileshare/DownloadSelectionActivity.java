...
public class DownloadSelectionActivity extends ListActivity {
    ...
    private class GetFileListTask extends AsyncTask<Void, Void, Void> {
        ...
        private final ThreadLocal<List<S3ObjectSummary>> s3ObjList = new ThreadLocal<>();
        ...
        protected Void doInBackground(Void... inputs) {
            ...
            s3ObjList.set(s3.listObjects(bucket).getObjectSummaries());
            transferRecordMaps.clear();
            for (S3ObjectSummary summary : Objects.requireNonNull(s3ObjList.get())) {
